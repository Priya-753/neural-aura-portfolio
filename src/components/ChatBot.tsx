...
const ChatBot: React.FC = () => {
  ...
  const botResponses: { [key: string]: string } = {
    "tell me about your work": "I am now training CrewAI agents to pull the precise SQL, Python, and AI-driven insights for an agentic DataOps platform. I have enjoyed creating vision games for stroke rehab, fine-tuning DistilBERT with LoRA, and previously scaling ML-driven retail and risk-analysis systems at startups and D.E. Shaw.",
    "show me a demo": "You can find interactive demos of my work on my GitHub profile. I've built real-time object detection systems, lovable clone, notion clone, sudoku solver, 2048 and document analyser. Check out the Experience section above for links to my projects!",
    "download resume": "You can download my complete resume from the Resume section above! It includes detailed information about my experience, education, skills, and achievements. Just scroll up to the Resume section and click the download button.",
